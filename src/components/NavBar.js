...
const NavBar = () => {
  ...
  return (
    ...
    '>
        ...
        onClick={handleClick}
        >
            <span className={`bg-dark dark:bg-light block transition-all duration-300 h-0.5 w-6 rounded-sm -transalte-y-0.5 ${isOpen ? 'rotate-45 translate-y-1' : '-transalte-y-0.5'} `}></span>
        ...
        <div className="w-full flex justify-between items-center lg:hidden">
            ...
            <motion.a  href="https://github.com/SheldonNg99" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
            ...
            <motion.a  href="https://www.linkedin.com/in/kai-jin-ng-99755b1a2/" target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className="w-6 mx-3"
            >
